...
class Verification(object):
    ...
    def verification_coherence(self, generaux, edition, acces, categories, categprix, clients, coefprests, comptes,
        ...
        verif += plafonds.est_coherent(subsides, artsap, plateformes)
        verif += cles.est_coherent(clients, machines, classes, subsides)
        verif += comptes.est_coherent(clients, subsides)
        verif += grants.est_coherent(comptes, artsap, plateformes)
